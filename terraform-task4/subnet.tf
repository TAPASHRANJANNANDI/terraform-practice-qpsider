...
resource "aws_subnet" "tapash-private-subnet-2" {
  vpc_id = aws_vpc.tapash-vpc.id
  cidr_block = var.tapash_private_subnet_2_cidr
  availability_zone = var.tapash_private_subnet_region_2
  tags = {
    Name = var.tapash_private_subnet_2_name
  }
}
