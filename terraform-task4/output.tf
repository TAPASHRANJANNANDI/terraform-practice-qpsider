...
output "tapash_private_subnet_2_name" {
    value = aws_subnet.tapash-private-subnet-2.tags["Name"]
}
...
output "tapash_private_route_table_2_name" {
    value = aws_route_table.tapash-private-route-table-2.tags["Name"]
}
