...
resource "aws_route_table_association" "tapash-public-subnet-2-association" {
  subnet_id = aws_subnet.tapash-public-subnet-2.id
  route_table_id = aws_route_table.tapash-public-route-table-2.id
}
